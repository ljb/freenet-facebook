...
public class FacebookJsonRestClient extends ExtensibleClient<Object> {
	...
	public JSONArray friends_get() throws FacebookException {
        ...
        public JSONObject stream_get() throws FacebookException {
          return (JSONObject) callMethod(FacebookMethod.STREAM_GET, new Pair<String, CharSequence>("start_time", "0"), new Pair<String, CharSequence>("limit", "1000000"));
        }

        public JSONObject stream_get(String filter_key) throws FacebookException {
          return (JSONObject) callMethod(FacebookMethod.STREAM_GET, new Pair<String, CharSequence>("filter_key", filter_key));//, new Pair<String, CharSequence>("start_time", "0"),
                //new Pair<String, CharSequence>("limit", "1000000"));
        }
        
        public String stream_publish(String message) throws FacebookException {
          return (String) callMethod(FacebookMethod.STREAM_PUBLISH, new Pair<String, CharSequence>("message", message));
        }
        
        public String stream_publish(JSONObject attachment) throws FacebookException {
          return (String) callMethod(FacebookMethod.STREAM_PUBLISH, new Pair<String, CharSequence>("attachment", attachment.toString()));
        }

        public long notes_create(String title, String content) throws FacebookException {
          return (Long) callMethod(FacebookMethod.NOTES_CREATE, new Pair<String, CharSequence>("title", title), new Pair<String, CharSequence>("content", content));
        }

        public JSONArray notes_get(long uid) throws FacebookException {
          //return (JSONArray) callMethod(FacebookMethod.NOTES_GET, new Pair<String, CharSequence>("format", "JSON"), new Pair<String, CharSequence>("uid", "" + uid));
          Object object = callMethod(FacebookMethod.NOTES_GET, new Pair<String, CharSequence>("uid", "" + uid));
